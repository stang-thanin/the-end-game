...
public class Thor extends Avengers implements Drawable {
	...
	public Thor(int row, int column, Group root, Player player) {
		this.player = player;
		this.row = row;
		this.column = column;
		this.image = new ImageView(new Image(ClassLoader.getSystemResource("Thor.png").toString()));
