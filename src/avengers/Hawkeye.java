...
public class Hawkeye extends Avengers implements Drawable {
	
	private int price = 1750;
	private int row;
	private int column;
	...
	public Hawkeye(int row, int column, Group root, Player player) {
		this.player = player;
		this.row = row;
		this.column = column;
		this.image = new ImageView(new Image(ClassLoader.getSystemResource("Hawkeye.png").toString()));
